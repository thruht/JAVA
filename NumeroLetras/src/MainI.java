...
//                System.out.println(" "+decii[0]);
    ...
    public static void especiales(int num1){
        String[] especiales={"Dies","Once","Doce","Trece","Catorce","Quince"};
        switch (num1){
        case 10:
            System.out.println(especiales[0]);
            break;
        case 11:
            System.out.println(especiales[1]);
            break;
        case 12:
            System.out.println(especiales[2]);
            break;
        case 13:
            System.out.println(especiales[3]);
            break;
        case 14:
            System.out.println(especiales[4]);
            break;
        case 15:
            System.out.println(especiales[5]);
            break;
    }
